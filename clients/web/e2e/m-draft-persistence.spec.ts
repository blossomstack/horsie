...
// model keys are exercised here; selection-set restore is unit-tested.
// The config keys are icon-only now, so the chosen value is read from the
// accessible name rather than from text content.
